---
title: Reports Index
description: Guide to all analysis documents - find what you need
order: 0
---

# Reports Directory

This directory contains multiple versions of the Chomsky analysis, designed for different audiences and purposes.
...
- **Best for:** Understanding who's involved
...
2. [Glossary]({{ '/reports/glossary/' | relative_url }}) (as needed)
3. [Timeline]({{ '/reports/timeline/' | relative_url }}) (for context)
...
4. [JSON Data]({{ '/reports/chomsky-verification-report-20251120-202811/' | relative_url }}) (for analysis)
...
**Choose the document that best fits your needs and reading level.**
